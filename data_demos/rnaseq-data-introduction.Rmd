...
```{r explore_data, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r explore_metadata, echo=FALSE, eval=TRUE, results='asis', message=FALSE, warning=FALSE}
...
```{r Gene_exp_lookup, echo=FALSE, eval=TRUE, results='asis', message=FALSE, warning=FALSE}
...
```{r GOsummaries, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
